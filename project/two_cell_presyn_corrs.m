...
num_points_gain = 10;
% gain_vector = linspace(-65,-55,num_points_gain);
gain_vector = linspace(0.01,10,num_points_gain);
rx_vector = linspace(10/1000,20/1000,num_points_gain);

num_points = 1;
jestim_vector = linspace(-0.2,0.2,num_points);
mean_rate_1 = zeros(num_points,num_points_gain);
mean_rate_2 = zeros(num_points,num_points_gain);
Corr_1_2 = zeros(num_points,num_points_gain);
...
figure; hold on
plot(gain_vector, Corr_1_2 , 'linewidth',3)
xlabel('V_T')
ylabel('Corr(n1,n2)')


figure; hold on
plot(gain_vector,1000*mean_rate_1,'linewidth',3,'color','r')
plot(gain_vector,1000*mean_rate_2,'linewidth',3,'color','b')
xlabel('V_T')
ylabel('Rate (Hz)')

%%
figure; hold on
plot(1000*rx_vector, Corr_1_2 , 'linewidth',3)
xlabel('r_X')
ylabel('Corr(n1,n2)')


figure; hold on
plot(1000*rx_vector,1000*mean_rate_1,'linewidth',3,'color','r')
plot(1000*rx_vector,1000*mean_rate_2,'linewidth',3,'color','b')
xlabel('r_X')
ylabel('Rate (Hz)')
