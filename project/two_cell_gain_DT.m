...
delta_vector = linspace(0.01,10,num_points_gain);
rx_vector = linspace(10/1000,20/1000,num_points_gain);

num_points_input = 1;
jestim_vector = linspace(-0.2,0.2,num_points_input);
...
figure; hold on
plot(delta_vector, Corr_1_2 , 'linewidth',3)
xlabel('V_T')
ylabel('Corr(n1,n2)')


figure; hold on
plot(delta_vector,1000*mean_rate_1,'linewidth',3,'color','r')
plot(delta_vector,1000*mean_rate_2,'linewidth',3,'color','b')
xlabel('D_T')
ylabel('Rate (Hz)')


save('./gain_mod_twocell_DT.mat', 'c','Cm','Corr_1_2','delta_vector',...
    'dt','dtRate','EL','gL','jestim_vector','Jxm1','Jxm2','mean_rate_1',...
    'mean_rate_2','num_points_input','num_points_gain',...
    'Nx','Px','rx_vector','T','T1','T2',...
    'Vre','VT','Vth','winsize');
