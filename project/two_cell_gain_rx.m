...
figure; hold on
plot(rx_vector, Corr_1_2 , 'linewidth',3)
xlabel('V_T')
ylabel('Corr(n1,n2)')


figure; hold on
plot(rx_vector,1000*mean_rate_1,'linewidth',3,'color','r')
plot(rx_vector,1000*mean_rate_2,'linewidth',3,'color','b')
xlabel('D_T')
ylabel('Rate (Hz)')


save('./gain_mod_twocell_rx.mat', 'c','Cm','Corr_1_2',...
